      ...
      {/* <button>Submit</button> */}
        <div className="account__login register">
          ...
          <div className="account__login--inner">
            <input className="account__login--input" placeholder="First Name" type="text" value={fullName} onChange={e => setFullName(e.target.value)} />
            <input className="account__login--input" placeholder="Last Name" type="text" value={last_name} onChange={e => setLastName(e.target.value)} />
            ...
            <input className="account__login--input" placeholder="Phone number" type="number" value={phoneNo} onChange={e => setPhoneNo(e.target.value)} />
            <input className="account__login--input" placeholder="Password" type="password" value={password} onChange={e => setPassword(e.target.value)} />
