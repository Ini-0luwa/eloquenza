...
function Header(props) {
  ...
  useEffect( ()=>{
    let store = api.store(store_id)
    store.then((res)=>{
      setStoreData([res])
    })
    
    let products = api.storeProducts(store_id)
    products.then((res)=>{
      setProducts([res])
    })
  ...
  return (
    ...
    <header className="header__section">
          ...
          <div className="header__topbar--inner d-flex align-items-center justify-content-between">
            <div className="header__shipping">
              <ul className="header__shipping--wrapper d-flex">
                <li className="header__shipping--text text-white">Welcome to Eloquenza Store</li>
        ...
        <div className="container-fluid">
          <div className="main__header--inner position__relative d-flex justify-content-between align-items-center">
            ...
            <div className="main__logo">
              <h1 className="main__logo--title"><Link className="main__logo--link" to="/"><img className=".main__logo--img" src={logo} alt="logo-img" /></Link></h1>
            </div>
            ...
            <div className="header__account header__sticky--none">
              <ul className="d-flex">
                ...
                <li className="header__account--items">
                  <Link to='/checkout' className="header__account--btn minicart__open--btn" data-offcanvas>
              ...
              <nav className="header__menu--navigation">
                <ul className="d-flex">
                  <li className="header__menu--items style2">
                    <Link className="header__menu--link" to="index.html">
                      Home
                    </Link>
                  </li>
                  <li className="header__menu--items style2">
                    <Link className="header__menu--link" to="about.html">About Us </Link>  
                  </li>
                  <li className="header__menu--items style2">
      ...
      <div className="header__bottom">
        <div className="container-fluid">
          <div className="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
            ...
            <p className="header__discount--text"><img className="header__discount--icon__img" src={lamp_icon} alt=''/> Special up to 60% Off all item</p>
          </div>
        </div>
      </div>
      ...
      <div className="d-lg-none">
        <div className={!toggle ? 'offcanvas__header' : 'offcanvas__header open'}>
          <div className="offcanvas__inner fixed-top">
            ...
            <nav className="offcanvas__menu">
              <ul className="offcanvas__menu_ul">
                ...
                <li className="offcanvas__menu_li">
                  <Link className="offcanvas__menu_item" to="/contact">contact</Link>
                </li>
                <li className="offcanvas__menu_li">
              ...
              {/* <div className="language__currency">
                <ul className="d-flex align-items-center">
                  <li className="language__currency--list">
                    <Link className="offcanvas__account--currency__menu" to="#">
      ...
      <div className="offcanvas__stikcy--toolbar">
        <ul className="d-flex justify-content-between">
          ...
          <li className="offcanvas__stikcy--toolbar__list">
            <NavLink className="offcanvas__stikcy--toolbar__btn" to={"/shop"}>
              <span className="offcanvas__stikcy--toolbar__icon">
          ...
          <li className="offcanvas__stikcy--toolbar__list">
            <NavLink className="offcanvas__stikcy--toolbar__btn .minicart__open--btn" to={"/checkout"}>
              <span className="offcanvas__stikcy--toolbar__icon">
      ...
      <div className="offCanvas__minicart">
        ...
        <div className="minicart__product">
          <div className="minicart__product--items d-flex">
            ...
            <div className="minicart__text">
              <h3 className="minicart__subtitle h4"><Link to="product-details.html">Oversize Cotton Dress</Link></h3>
          ...
          <div className="minicart__product--items d-flex">
            ...
            <div className="minicart__text">
              <h3 className="minicart__subtitle h4"><Link to="product-details.html">Boxy Denim Jacket</Link></h3>
        ...
        <div className="minicart__button d-flex justify-content-center">
          ...
          <Link className="primary__btn minicart__button--link" to="checkout.html">Checkout</Link>
        </div>
      </div>
