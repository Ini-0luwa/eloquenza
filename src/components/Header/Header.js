          ...
          <nav class="offcanvas__menu">
            <ul class="offcanvas__menu_ul">
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="index.html">Home</Link>
                <ul class="offcanvas__sub_menu">
                  <li class="offcanvas__sub_menu_li"><Link to="index.html" class="offcanvas__sub_menu_item">Home One</Link></li>
                  <li class="offcanvas__sub_menu_li"><Link to="index-2.html" class="offcanvas__sub_menu_item">Home Two</Link></li>
                  <li class="offcanvas__sub_menu_li"><Link to="index-3.html" class="offcanvas__sub_menu_item">Home Three</Link></li>
                </ul>
              </li>
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="#">Shop</Link>
              </li>
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="#">Blog</Link>
              </li>
              <li class="offcanvas__menu_li">
      ...
      <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
          <li class="offcanvas__stikcy--toolbar__list">
            <Link class="offcanvas__stikcy--toolbar__btn" to="index.html">
          ...
          <li class="offcanvas__stikcy--toolbar__list">
            <Link class="offcanvas__stikcy--toolbar__btn" to="shop.html">
              <span class="offcanvas__stikcy--toolbar__icon">
          ...
          <li class="offcanvas__stikcy--toolbar__list">
            <Link class="offcanvas__stikcy--toolbar__btn" to="wishlist.html">
              <span class="offcanvas__stikcy--toolbar__icon">
