  ...
  return (
    ...
    <header class="header__section">
          ...
          <div class="header__topbar--inner d-flex align-items-center justify-content-between">
            ...
            <div class="language__currency d-none d-lg-block">
              ...
              <select class=".header__select--inner">
                ...
                <option value="2"><li class="currency__items"><Link class="currency__text" to="#">CAD</Link></li></option>
                <option value="3"><li class="currency__items"><Link class="currency__text" to="#">CNY</Link></li></option>
                <option value="4"><li class="currency__items"><Link class="currency__text" to="#">EUR</Link></li></option>
                <option value="5"><li class="currency__items"><Link class="currency__text" to="#">GBP</Link></li></option>
              </select>
              </ul>
            </div>
          </div>
        ...
        <div class="container-fluid">
          <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
            <div class="offcanvas__header--menu__open ">
              <Link class="offcanvas__header--menu__open--btn" data-offcanvas onClick={()=>setToggle(!toggle)}>
                {!toggle ? <svg xmlns="http://www.w3.org/2000/svg" class="ionicon offcanvas__header--menu__open--svg" viewBox="0 0 512 512">
                  <path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M80 160h352M80 256h352M80 352h352"/>
                </svg> :
                <button class="offcanvas__close--btn" data-offcanvas style={{marginLeft: "30rem", zIndex: "100"}}>close</button>}
              ...
              <nav class="header__menu--navigation">
                <ul class="d-flex">
                  <li class="header__menu--items style2">
                    <Link class="header__menu--link" to="index.html">
                      Home
                    </Link>
                  </li>
                  <li class="header__menu--items style2">
                  ...
                  <li class="header__menu--items mega__menu--items style2">
                    <Link class="header__menu--link" to="shop.html">
                      Shop 
                    </Link>
                  </li>
                </ul>
            ...
            <div class="header__account header__account2 header__sticky--block">
              <ul class="d-flex">
                ...
                <li class="header__account--items header__account2--items d-none d-lg-block">
                  <Link class="header__account--btn" to="wishlist.html">
      ...
      <div class="header__bottom">
        <div class="container-fluid">
          <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
              ...
              <nav class="header__menu--navigation">
                <ul class="d-flex">
                  ...
                  <li class="header__menu--items mega__menu--items">
                    <NavLink className='nav' to='/shop'><a class="header__menu--link" href="/">
                      Shop 
                    </a></NavLink>
                  </li>
                </ul>
            ...
            <p class="header__discount--text"><img class="header__discount--icon__img" src={lamp_icon} alt=''/> Special up to 60% Off all item</p>
          </div>
        </div>
      </div>
      ...
      <div class={toggle ? "offcanvas__header open" : 'offcanvas__header'}>
        <div class="offcanvas__inner fixed-top">
          ...
          <nav class="offcanvas__menu">
            <ul class="offcanvas__menu_ul">
              ...
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="/about">About Us</Link>
              </li>
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="/contact">contact</Link>
              </li>
              <li class="offcanvas__menu_li">
            ...
            <div class="offcanvas__account--items">
              <Link class="offcanvas__account--items__btn d-flex align-items-center" to="/login">
            ...
            {/* <div class="language__currency">
              <ul class="d-flex align-items-center">
                <li class="language__currency--list">
                  <Link class="offcanvas__account--currency__menu" to="#">
                    <img src={usd_icon} alt="currency" />
                    <span>$ US Dollar</span> 
                  ...
                  <div class="offcanvas__account--currency__submenu">
                    <ul>
                      <li class="currency__items"><Link class="currency__text" to="#">CAD</Link></li>
                      <li class="currency__items"><Link class="currency__text" to="#">CNY</Link></li>
                      <li class="currency__items"><Link class="currency__text" to="#">EUR</Link></li>
                      <li class="currency__items"><Link class="currency__text" to="#">GBP</Link></li>
                    </ul>
                  </div>
                </li>
              </ul>
      ...
      <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
          <li class="offcanvas__stikcy--toolbar__list">
            <NavLink class="offcanvas__stikcy--toolbar__btn" to={"/"}>
          ...
          <li class="offcanvas__stikcy--toolbar__list">
            <NavLink class="offcanvas__stikcy--toolbar__btn" to={"/shop"}>
              <span class="offcanvas__stikcy--toolbar__icon">
          ...
          <li class="offcanvas__stikcy--toolbar__list">
            <NavLink class="offcanvas__stikcy--toolbar__btn" to={"about"}>
              <span class="offcanvas__stikcy--toolbar__icon">
          ...
          <li class="offcanvas__stikcy--toolbar__list">
            <NavLink class="offcanvas__stikcy--toolbar__btn .minicart__open--btn" to={"/checkout"}>
              <span class="offcanvas__stikcy--toolbar__icon">
      ...
      <div class="offCanvas__minicart">
        ...
        <div class="minicart__product">
          <div class="minicart__product--items d-flex">
            ...
            <div class="minicart__text">
              <h3 class="minicart__subtitle h4"><Link to="product-details.html">Oversize Cotton Dress</Link></h3>
          ...
          <div class="minicart__product--items d-flex">
            ...
            <div class="minicart__text">
              <h3 class="minicart__subtitle h4"><Link to="product-details.html">Boxy Denim Jacket</Link></h3>
        ...
        <div class="minicart__conditions text-center">
          ...
          <label class="minicart__conditions--label" for="accept">I agree with the <Link class="minicart__conditions--link" to="privacy-policy.html">Privacy and Policy</Link></label>
        </div>
        <div class="minicart__button d-flex justify-content-center">
          <Link class="primary__btn minicart__button--link" to="cart.html">View cart</Link>
          <Link class="primary__btn minicart__button--link" to="checkout.html">Checkout</Link>
        </div>
      </div>
