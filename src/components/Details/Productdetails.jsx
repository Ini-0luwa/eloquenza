            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product2.jpg"><img class="product__media--preview__items--img" src={bigproduct2} alt="product-media-img" /></a>
              ...
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product1.jpg"><img class="product__media--preview__items--img" src={bigproduct1} alt="product-media-img" /></a>
                  <div class="product__media--view__icon">
              ...
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product3.jpg"><img class="product__media--preview__items--img" src={bigproduct3} alt="product-media-img" /></a>
                  <div class="product__media--view__icon">
              ...
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product4.jpg"><img class="product__media--preview__items--img" src={bigproduct4} alt="product-media-img" /></a>
                  <div class="product__media--view__icon">
              ...
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product5.jpg"><img class="product__media--preview__items--img" src={bigproduct5} alt="product-media-img" /></a>
                  <div class="product__media--view__icon">
              ...
              <div class="swiper-slide">
                <div class="product__media--preview__items">
                  <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product6.jpg"><img class="product__media--preview__items--img" src={bigproduct6} alt="product-media-img" /></a>
                  <div class="product__media--view__icon">
        ...
        <div class="product__details--info">
          <form action="#">
            ...
            <div class="product__variant">
              <div class="product__variant--list mb-10">
                <fieldset class="variant__input--fieldset">
                  ...
                  <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src={product1} alt="variant-color-img" /></label>
                  <input id="color-red2" name="color" type="radio" />
                  <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src={product2} alt="variant-color-img" /></label>
                  <input id="color-red3" name="color" type="radio" />
                  <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src={product3} alt="variant-color-img" /></label>
                  <input id="color-red4" name="color" type="radio" />
                  <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src={product4} alt="variant-color-img" /></label>
                </fieldset>
              </div>
            ...
            <div class="guarantee__safe--checkout">
              ...
              <img class="guarantee__safe--checkout__img" src={checkout} alt="Payment Image" />
            </div>
          </form>
        </div>
      </div>
