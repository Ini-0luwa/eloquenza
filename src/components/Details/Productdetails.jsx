        ...
        <div class="product__details--info">
          <form action="#">
            ...
            <div class="quickview__social d-flex align-items-center mb-15">
              ...
              <ul class="quickview__social--wrapper mt-0 d-flex">
                <li class="quickview__social--list">
                  <Link class="quickview__social--icon" to="https://www.facebook.com/">
                ...
                <li class="quickview__social--list">
                  <Link class="quickview__social--icon"  to="https://twitter.com/">
                ...
                <li class="quickview__social--list">
                  <Link class="quickview__social--icon" to="https://www.instagram.com/">
                ...
                <li class="quickview__social--list">
                  <Link class="quickview__social--icon" to="https://www.youtube.com/">
            ...
            <div class="guarantee__safe--checkout">
              ...
              <img class="guarantee__safe--checkout__img" src={checkout} alt="Payment"/>
            </div>
          </form>
        </div>
      </div>
