    ...
    <footer class="footer__section bg__black">
      <div class="container-fluid">
        <div class="main__footer .d-flex row">
          <div class="footer__widget col-lg-7 col-12">
            ...
            <div class=".footer__widget--inner">
              <h3 class="social__title text-ofwhite h4 mb-15">Welcome to  EloskinCare by Eloquenza.</h3>
              <p class="footer__widget--desc text-ofwhite mb-20" style={{fontSize: '1.2rem'}}>Home of 100% pure natural herbal and Organic products specialise in corrective skincare & skin lightening formulated to treat Hyperpigmentation, dark marks and uneven skin tones.
              ...
              <div class="footer__social">
                <ul class="social__shear d-flex">
                  <li class="social__shear--list">
                    <Link class="social__shear--list__icon" target="_blank" to="https://www.facebook.com/" rel="noopener noreferrer">
                  ...
                  <li class="social__shear--list">
                    <Link class="social__shear--list__icon" target="_blank" to="https://twitter.com/" rel="noopener noreferrer">
                  ...
                  <li class="social__shear--list">
                    <Link class="social__shear--list__icon" target="_blank" to="https://www.instagram.com/" rel="noopener noreferrer">
                  ...
                  <li class="social__shear--list">
                    <Link class="social__shear--list__icon" target="_blank" to="https://www.youtube.com/" rel="noopener noreferrer">
          ...
          <div class=".footer__widget--menu__wrapper pt-5 d-flex justify-content-around footer__widget--width col-lg-5 .ps-5 .ms-5">
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
          <p class="copyright__content text-ofwhite m-0">Copyright © 2022 <Link class="copyright__content--link" to="index.html">Suruchi</Link> . All Rights Reserved.Design By Suruchi</p>
          <div class="footer__payment text-right">
            <img class="display-block" src={visa_card} alt="visa-card" />
          </div>
        </div>
      </div>
    </footer>
