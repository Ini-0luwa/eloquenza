            ...
            <div className="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
              ...
              <div className="col mb-30">
                <div className="product__items ">
                  <div className="product__items--thumbnail">
                    <Link className="product__items--link" to="/productdetail">
                    <img className="product__items--img product__primary--img" src={product12} alt="product-img" />
                    <img className="product__items--img product__secondary--img" src={product13} alt="product-img" />
                    </Link>
                    <div className="product__badge">
                      <span className="product__badge--items sale">Sale</span>
                    </div>
                  ...
                  <div className="product__items--content">
                    <span className="product__items--content__subtitle">Jacket, Women</span>
                    <h4 className="product__items--content__title"><Link to="/productdetail">Wool-blend Jacket</Link></h4>
                    <div className="product__items--price">
