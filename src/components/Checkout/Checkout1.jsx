    ...
    <main className="main__content_wrapper">
      <form action="#">
        ...
        <div className="checkout__content--step__footer d-flex align-items-center">
          <Link className="continue__shipping--btn primary__btn border-radius-5" to="/checkout2">Continue To Shipping</Link>
          <Link className="previous__link--content" onClick={()=>navigate(-1)}>Return to cart</Link>
        </div>
      </form>
    </main>
