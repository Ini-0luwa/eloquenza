...
<div class="main checkout__mian">
  <header class="main__header checkout__mian--header mb-30">
    <h1 class="main__logo--title"><a class="logo logo__left mb-20" href="index.html"><img src={logo} alt="logo" /></a></h1>
  ...
  <main class="main__content_wrapper">
    <form action="#">
      ...
      <div class="checkout__content--step section__shipping--address">
        ...
        <div class="checkout__content--step__inner3 border-radius-5">
          <div class="checkout__address--content__header d-flex align-items-center justify-content-between">
            ...
            {/* <span class="heckout__address--content__icon"><img src={credit_card} alt="card" /></span> */}
      ...
      <div class="checkout__content--step__footer d-flex align-items-center">
        <Link class="continue__shipping--btn primary__btn border-radius-5" to="/checkout3">Pay now</Link>
        <Link class="previous__link--content" onClick={()=>navigate(-1)}>Return to shipping</Link>
      </div>
    </form>
  </main>
