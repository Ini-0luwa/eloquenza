    ...
    <div className="pagination__area bg__gray--color">
      <nav className="pagination justify-content-center">
        <ul className="pagination__wrapper d-flex align-items-center justify-content-center">
          ...
          <li className="pagination__list"><span className={page === 1 ? 'pagination__item--current pagination__item' : 'pagination__item'}
           onClick={decrePage}
          >1</span></li>
          <li className="pagination__list"><Link to="" className={page === 2 ? 'pagination__item--current pagination__item' : 'pagination__item'} onClick={increPage}>2</Link></li>
          ...
          {/* <li className="pagination__list"><Link to="" className="pagination__item link">{page}</Link></li> */}
          <li className="pagination__list">
            <Link to="" className="pagination__item--arrow  link " onClick={increPage}>
              <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512">
