              ...
              <div class="product__items ">
                ...
                <div class="product__items--content">
                  ...
                  <ul class="product__items--action d-flex">
                    ...
                    <li class="product__items--action__list">
                      <Link class="product__items--action__btn" data-open="modal1" to="">
                        <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg"  width="25.51" height="23.443" viewBox="0 0 512 512">
    ...
    <div class="pagination__area bg__gray--color">
      <nav class="pagination justify-content-center">
        <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
          ...
          <li class="pagination__list"><Link to="" class="pagination__item link">2</Link></li>
          <li class="pagination__list"><Link to="" class="pagination__item link">3</Link></li>
          <li class="pagination__list"><Link to="" class="pagination__item link">4</Link></li>
          <li class="pagination__list">
            <Link to="shop.html" class="pagination__item--arrow  link ">
              <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512">
